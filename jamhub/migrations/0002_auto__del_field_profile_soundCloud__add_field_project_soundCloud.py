...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.soundCloud'
        db.delete_column('jamhub_profile', 'soundCloud')

        # Adding field 'Project.soundCloud'
        db.add_column('jamhub_project', 'soundCloud',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.soundCloud'
        db.add_column('jamhub_profile', 'soundCloud',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300),
                      keep_default=False)

        # Deleting field 'Project.soundCloud'
        db.delete_column('jamhub_project', 'soundCloud')
